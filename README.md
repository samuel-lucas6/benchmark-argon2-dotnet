...
| Method            | MemorySize | Iterations | Mean        | Error     | StdDev    |
|------------------ |----------- |----------- |------------:|----------:|----------:|
| **Monocypher.Argon2** | **32 MiB**   | **1**          |    **125.8 ms** |   **1.02 ms** |   **0.96 ms** |
| **Monocypher.Argon2** | **32 MiB**   | **3**          |    **359.7 ms** |   **2.21 ms** |   **2.06 ms** |
| **Monocypher.Argon2** | **32 MiB**   | **6**          |    **719.3 ms** |   **0.81 ms** |   **0.63 ms** |
| **Monocypher.Argon2** | **64 MiB**   | **1**          |    **249.7 ms** |   **1.36 ms** |   **1.27 ms** |
| **Monocypher.Argon2** | **64 MiB**   | **3**          |    **727.3 ms** |   **2.69 ms** |   **2.24 ms** |
| **Monocypher.Argon2** | **64 MiB**   | **6**          |  **1,445.4 ms** |  **10.90 ms** |   **9.10 ms** |
| **Monocypher.Argon2** | **128 MiB**  | **1**          |    **502.0 ms** |   **4.59 ms** |   **4.29 ms** |
| **Monocypher.Argon2** | **128 MiB**  | **3**          |  **1,460.3 ms** |   **3.18 ms** |   **2.66 ms** |
| **Monocypher.Argon2** | **128 MiB**  | **6**          |  **2,902.7 ms** |   **2.37 ms** |   **1.85 ms** |
| **Monocypher.Argon2** | **256 MiB**  | **1**          |  **1,038.3 ms** |  **10.93 ms** |  **10.22 ms** |
| **Monocypher.Argon2** | **256 MiB**  | **3**          |  **3,004.2 ms** |  **14.24 ms** |  **13.32 ms** |
| **Monocypher.Argon2** | **256 MiB**  | **6**          |  **5,934.1 ms** |   **8.71 ms** |   **6.80 ms** |
| **Monocypher.Argon2** | **512 MiB**  | **1**          |  **2,074.0 ms** |   **3.77 ms** |   **3.35 ms** |
| **Monocypher.Argon2** | **512 MiB**  | **3**          |  **5,999.3 ms** |  **29.20 ms** |  **25.89 ms** |
| **Monocypher.Argon2** | **512 MiB**  | **6**          | **11,860.7 ms** |  **99.90 ms** |  **93.44 ms** |
| **Monocypher.Argon2** | **768 MiB**  | **1**          |  **3,121.3 ms** |  **19.02 ms** |  **17.79 ms** |
| **Monocypher.Argon2** | **768 MiB**  | **3**          |  **9,061.2 ms** |   **6.59 ms** |   **6.16 ms** |
| **Monocypher.Argon2** | **768 MiB**  | **6**          | **18,056.4 ms** | **142.48 ms** | **133.27 ms** |
| **Monocypher.Argon2** | **1 GiB** | **1**          |  **4,152.4 ms** |   **6.94 ms** |   **6.49 ms** |
| **Monocypher.Argon2** | **1 GiB** | **3**          | **12,082.7 ms** | **145.81 ms** | **136.39 ms** |
| **Monocypher.Argon2** | **1 GiB** | **6**          | **23,784.5 ms** | **163.53 ms** | **152.97 ms** |

### Konscious
| Method           | MemorySize | Iterations | Mean        | Error     | StdDev    |
|----------------- |----------- |----------- |------------:|----------:|----------:|
| **Konscious.Argon2** | **32 MiB**   | **1**          |    **38.49 ms** |  **0.109 ms** |  **0.097 ms** |
| **Konscious.Argon2** | **32 MiB**   | **3**          |   **110.77 ms** |  **0.437 ms** |  **0.408 ms** |
| **Konscious.Argon2** | **32 MiB**   | **6**          |   **219.16 ms** |  **0.624 ms** |  **0.553 ms** |
| **Konscious.Argon2** | **64 MiB**   | **1**          |    **78.01 ms** |  **0.324 ms** |  **0.303 ms** |
| **Konscious.Argon2** | **64 MiB**   | **3**          |   **225.99 ms** |  **1.176 ms** |  **1.100 ms** |
| **Konscious.Argon2** | **64 MiB**   | **6**          |   **446.08 ms** |  **3.118 ms** |  **2.917 ms** |
| **Konscious.Argon2** | **128 MiB**  | **1**          |   **158.09 ms** |  **0.939 ms** |  **0.878 ms** |
| **Konscious.Argon2** | **128 MiB**  | **3**          |   **460.05 ms** |  **3.360 ms** |  **3.143 ms** |
| **Konscious.Argon2** | **128 MiB**  | **6**          |   **910.16 ms** |  **4.817 ms** |  **4.506 ms** |
| **Konscious.Argon2** | **256 MiB**  | **1**          |   **319.78 ms** |  **1.854 ms** |  **1.735 ms** |
| **Konscious.Argon2** | **256 MiB**  | **3**          |   **922.34 ms** |  **1.454 ms** |  **1.360 ms** |
| **Konscious.Argon2** | **256 MiB**  | **6**          | **1,825.25 ms** |  **1.388 ms** |  **1.230 ms** |
| **Konscious.Argon2** | **512 MiB**  | **1**          |   **649.95 ms** |  **1.900 ms** |  **1.684 ms** |
| **Konscious.Argon2** | **512 MiB**  | **3**          | **1,876.59 ms** |  **2.669 ms** |  **2.497 ms** |
| **Konscious.Argon2** | **512 MiB**  | **6**          | **3,726.51 ms** | **28.166 ms** | **26.347 ms** |
| **Konscious.Argon2** | **768 MiB**  | **1**          |   **990.51 ms** | **10.592 ms** |  **9.907 ms** |
| **Konscious.Argon2** | **768 MiB**  | **3**          | **2,847.02 ms** | **24.236 ms** | **22.671 ms** |
| **Konscious.Argon2** | **768 MiB**  | **6**          | **5,661.55 ms** | **40.313 ms** | **37.709 ms** |
| **Konscious.Argon2** | **1 GiB** | **1**          | **1,325.72 ms** | **13.766 ms** | **12.877 ms** |
| **Konscious.Argon2** | **1 GiB** | **3**          | **3,821.70 ms** | **35.343 ms** | **33.060 ms** |
| **Konscious.Argon2** | **1 GiB** | **6**          | **7,486.17 ms** | **32.776 ms** | **25.590 ms** |

### Isopoh
| Method        | MemorySize | Iterations | Mean        | Error     | StdDev    | Median      |
|-------------- |----------- |----------- |------------:|----------:|----------:|------------:|
| **Isopoh.Argon2** | **32 MiB**   | **1**          |    **41.46 ms** |  **0.674 ms** |  **1.144 ms** |    **41.02 ms** |
| **Isopoh.Argon2** | **32 MiB**   | **3**          |   **108.74 ms** |  **0.591 ms** |  **0.553 ms** |   **108.77 ms** |
| **Isopoh.Argon2** | **32 MiB**   | **6**          |   **213.29 ms** |  **2.806 ms** |  **2.343 ms** |   **212.50 ms** |
| **Isopoh.Argon2** | **64 MiB**   | **1**          |    **85.51 ms** |  **1.681 ms** |  **2.900 ms** |    **86.79 ms** |
| **Isopoh.Argon2** | **64 MiB**   | **3**          |   **222.40 ms** |  **0.646 ms** |  **0.604 ms** |   **222.36 ms** |
| **Isopoh.Argon2** | **64 MiB**   | **6**          |   **438.00 ms** |  **0.773 ms** |  **0.723 ms** |   **437.83 ms** |
| **Isopoh.Argon2** | **128 MiB**  | **1**          |   **167.42 ms** |  **3.345 ms** |  **6.116 ms** |   **169.90 ms** |
| **Isopoh.Argon2** | **128 MiB**  | **3**          |   **459.06 ms** |  **2.496 ms** |  **2.335 ms** |   **458.12 ms** |
| **Isopoh.Argon2** | **128 MiB**  | **6**          |   **920.57 ms** |  **5.327 ms** |  **4.983 ms** |   **920.04 ms** |
| **Isopoh.Argon2** | **256 MiB**  | **1**          |   **321.55 ms** |  **3.257 ms** |  **2.720 ms** |   **321.37 ms** |
| **Isopoh.Argon2** | **256 MiB**  | **3**          |   **953.90 ms** |  **1.791 ms** |  **1.587 ms** |   **953.80 ms** |
| **Isopoh.Argon2** | **256 MiB**  | **6**          | **1,904.65 ms** | **13.461 ms** | **12.592 ms** | **1,900.45 ms** |
| **Isopoh.Argon2** | **512 MiB**  | **1**          |   **717.74 ms** | **14.202 ms** | **26.675 ms** |   **728.49 ms** |
| **Isopoh.Argon2** | **512 MiB**  | **3**          | **1,990.66 ms** | **37.234 ms** | **34.829 ms** | **1,986.92 ms** |
| **Isopoh.Argon2** | **512 MiB**  | **6**          | **3,966.58 ms** | **48.672 ms** | **45.528 ms** | **3,964.78 ms** |
| **Isopoh.Argon2** | **768 MiB**  | **1**          | **1,072.28 ms** | **20.810 ms** | **31.780 ms** | **1,085.03 ms** |
| **Isopoh.Argon2** | **768 MiB**  | **3**          | **3,057.95 ms** | **33.916 ms** | **31.725 ms** | **3,070.98 ms** |
| **Isopoh.Argon2** | **768 MiB**  | **6**          | **6,022.12 ms** | **28.323 ms** | **23.651 ms** | **6,021.83 ms** |
| **Isopoh.Argon2** | **1 GiB** | **1**          | **1,461.72 ms** | **28.951 ms** | **37.645 ms** | **1,472.07 ms** |
| **Isopoh.Argon2** | **1 GiB** | **3**          | **4,128.55 ms** |  **9.926 ms** |  **8.288 ms** | **4,127.23 ms** |
| **Isopoh.Argon2** | **1 GiB** | **6**          | **8,188.90 ms** | **80.073 ms** | **74.901 ms** | **8,180.37 ms** |
